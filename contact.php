...
<div id="wrapper">
  ...
  <div id="content">
	...
	<h2>Feel Free to contact us:</h2>
	  ...
	  <form method="post" action="conttab.php" >
	   <table border="0" height="250" width="400" >
          <tr>
		  <td>Name:</td>
		  <td><input type="text" value="" name="name" size="10" class="input_field"  Placeholder="Type your name please" /></td>
		  </tr>
		  <tr>
		  <td>Email:</td>
		  <td><input type="text" value="" name="email" size="10" class="input_field" Placeholder="Type your email address"/></td>
		   </tr>
		  <tr>
		  <td>message:</td>
		  <td><textarea name="message" cols="50" rows="4" maxlength="100" placeholder="type your message"></textarea></td>
		  </tr>
			</table>
			<input type="submit" name="save" id="f1" value="Send Message">
                </form>
	<!-- InstanceEndEditable -->
