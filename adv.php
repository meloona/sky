...
<br>
<center><font face="serif" size="20px"> 
<b><script>
var text="Advertisements" // YOUR TEXT
...
<table align="right" height="400" width="650"><tr><td><fieldset><legend align="top"> Advertisements Details </legend>
 
 <table >
<tr><td> Your Category:</td>
<td><select name="cf">
<option >-choice-</option>
  <option value="clothes">clothes</option>
  <option value="jewellery for man">jewellery for man</option>
  <option value="jewellery for woman">jewellery for woman</option>
  <option value="Abaya">Abaya</option>
  <option value="Parties">Parties</option>
  <option value="Hena">Hena</option>
  <option value="Others">Others</option>
</select></td></tr>
<tr><td> Describe your product:</td>
<td><label for="textarea"></label>
  <textarea name="txtdescribe" id="textarea" cols="30" rows="4"></textarea></td></tr>
<tr><td> City:</td>
<td>
<input type="text" size="15" name="city" maxlength="33"/>
</td></tr>
 <tr><td> customer contact:</td>
<td> <input type="text" size="15" name="phone" maxlength="33"/></td></tr>

<tr>
<td>To Upload your product image:</td>
<td>
