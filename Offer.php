...
include('Conn.php');
		...
		$sql="SELECT products.Pro_ID,products.Pro_Name,products.Descp,products.Price,products.Dis_Price,products.MainPic,tblprocat.Cat_Name from products INNER JOIN tblprocat ON products.Cat_ID = tblprocat.Cat_ID where Offer='1'";
	...
	<h2>Offers Pages</h2>
     ...
     <?php if ($count!=0){
      ...
      <div class="product_box margin_r35">
        ...
        <img class="pic" src="<?php echo $row['Cat_Name'].'/'.$row['MainPic'];?>" alt="" />
         <img class="picbig" src="<?php echo $row['Cat_Name'].'/'.$row['MainPic'];?>" alt="" />
        </a> </div>
        <p class="price">Selling Price:<strike>OR<?php echo $row['Price'];?></strike></p>
		<p class="price">Price discount:OR<?php echo $row['Dis_Price'];?></p>
        <p class="price">Category: <?php echo $row['Cat_Name'];?></p>
        <a href="addCart.php?ID=<?php echo $row['Pro_ID'];?>">Add Cart</a>
         </div>
		<?php }}?>
     <!-- <div class="product_box margin_r35">
         <div class="image_wrapper"> <a href="#"><img src="parties/a.png" alt="" width="190" height="100"/></a> </div>
        <p class="price">Selling Price:<strike>OR250</strike></p>
		<p class="price">Price after discount: OR200</p>
        <a href="buy.html">Buy Now</a> </div>
		
      <div class="product_box margin_r35">
       <div class="image_wrapper"> <a href="#"><img src="abaia/df.png" alt="" width="190" height="100"/></a> </div>
        <p class="price">Selling Price:<strike>OR30</strike></p>
		<p class="price">Price after discount: OR25</p>
        <a href="buy.html">Buy Now</a>  </div>
		
		
      <div class="product_box margin_r35">
       <div class="image_wrapper"> <a href="#"><img src="hena/xz.jpg" alt="" width="190" height="100"/></a> </div>
        <p class="price">Selling Price:<strike>OR1</strike></p>
		<p class="price">Price after discount: bz.500</p>
       <a href="buy.html">Buy Now</a> </div>
	   
	   <div class="product_box margin_r35">
	   <div class="image_wrapper"> <a href="#"><img src="jww/d.jpg" alt="" width="190" height="100"/></a> </div>
        <p class="price">Selling Price:<strike>OR20</strike></p>
		<p class="price">Price after discount: OR15</p>
         <a href="buy.html">Buy Now</a> </div>
		 
		 <div class="product_box margin_r35">
		  <div class="image_wrapper"> <a href="#"><img src="jwm/q.jpg" alt="" width="190" height="100"/></a> </div>
        <p class="price">Selling Price:<strike>OR10</strike></p>
		<p class="price">Price after discount: OR8</p>
         <a href="buy.html">Buy Now</a></div>-->
