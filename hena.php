...
include('Conn.php');
		...
		$sql="SELECT products.Pro_ID,products.Pro_Name,products.Descp,products.Price,products.Dis_Price,products.MainPic,tblprocat.Cat_Name from products INNER JOIN tblprocat ON products.Cat_ID = tblprocat.Cat_ID where Pro_Name='D'";
