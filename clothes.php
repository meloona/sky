...
include('Conn.php');
		...
		$sql="SELECT products.Pro_ID,products.Pro_Name,products.Descp,products.Price,products.Dis_Price,products.MainPic,tblprocat.Cat_Name from products INNER JOIN tblprocat ON products.Cat_ID = tblprocat.Cat_ID where Pro_Name='A'";
...
<br />
	 ...
	 <!--<h2>Our products</h2>
      <div class="product_box margin_r35">
        <div class="image_wrapper" > <a href="#"><img src="clothes/aw.jpg" alt="" width="190" height="100"/></a> </div>
        <p class="price">Price: OR70</p>
        <a href="buy.html">Buy Now</a> </div>
      <div class="product_box margin_r35">
      
        <div class="image_wrapper"> <a href="#"><img src="clothes/ds.jpg" alt="" width="190" height="100"/></a> </div>
        <p class="price">Price: OR80</p>
        <a href="buy.html">Buy Now</a> </div>
            <div class="cleaner"></div>
      <div class="product_box margin_r35">
                <div class="image_wrapper"> <a href="#"><img src="clothes/wq.jpg" alt="" width="190" height="100"/></a> </div>
        <p class="price">Price: OR50</p>
          <a href="buy.html">Buy Now</a></div>
      <div class="product_box margin_r35">
               <div class="image_wrapper"> <a href="#"><img src="clothes/xz.jpg" alt="" width="190" height="100" /></a> </div>
        <p class="price">Price: OR60</p>
       <a href="buy.html">Buy Now</a></div>-->
